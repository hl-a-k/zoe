...
@Documented
@Inherited
@Import(Sql2oJpaRepositoriesRegistrar.class)
public @interface EnableSql2oJpaRepositories {
    ...
    /**
     * Configures the location of where to findAll the Spring Data named queries properties file. Will default to
     ...
     * {@link Sql2oJpaRepositoryFactoryBean}.
     *
     * @return
     */
    Class<?> repositoryFactoryBeanClass() default Sql2oJpaRepositoryFactoryBean.class;
     ...
     * @since 1.9
     */
    Class<?> repositoryBaseClass() default Sql2oJpaRepository.class;
