package com.zoe.framework.shiro.util;
...
/**
 * 实现可以序列化的ZoeSimpleByteSource。
 * Created by caizhicong on 2016/1/14.
 */
public class ZoeSimpleByteSource implements ByteSource, Serializable {

    private byte[] bytes;
    private String cachedHex;
    private String cachedBase64;

    public ZoeSimpleByteSource(){

    }

    public ZoeSimpleByteSource(byte[] bytes) {
        this.bytes = bytes;
    }
     ...
     * @since 1.1
     */
    public ZoeSimpleByteSource(char[] chars) {
     ...
     * @since 1.1
     */
    public ZoeSimpleByteSource(String string) {
     ...
     * @since 1.1
     */
    public ZoeSimpleByteSource(ByteSource source) {
     ...
     * @since 1.1
     */
    public ZoeSimpleByteSource(File file) {
     ...
     * @since 1.1
     */
    public ZoeSimpleByteSource(InputStream stream) {
