...
import com.zoe.framework.sql2o.logging.SysOutLogger;
import com.zoe.framework.sql2o.quirks.Quirks;

/**
 * Iterator for a {@link java.sql.ResultSet}. Tricky part here is getting
...
public abstract class ResultSetIteratorBase<T> implements Iterator<T> {
	...
	public ResultSetIteratorBase(ResultSet rs, boolean isCaseSensitive,
			Quirks quirks) {
		this.rs = rs;
	...
	private ResultSetValue<T> next; // keep track of next item in case hasNext()
