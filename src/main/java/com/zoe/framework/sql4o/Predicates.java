...
public final class Predicates {
     ...
     *
     * @param expr SQL numeric expression to check.
     * @param bits Integer containing the bits for which to check.
     */
     ...
     * </pre>
     *
     * @param table Table that forms the basis of the sub-select.
     */
     ...
     *
     * @param childPredicate Predicate whose sense is to be inverted.
     */
