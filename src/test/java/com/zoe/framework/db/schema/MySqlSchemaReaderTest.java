...
/**
 * Created by caizhicong on 2016/5/21.
 */
public class MySqlSchemaReaderTest extends BaseTest {
    @Autowired
    ...
    public void Test03() {
        ...
        if (tables.size() > 0) {
            ...
            List<Column> columns1 = schemaReader.getTableColumns(new Table("ZOEDDC", tables.get(0).getName()));
